...
transition is that the scale is changing in the css and the border color also changed or transitioned.
*/
    ...
    /* window.addEventListener('transitionend', function(e) {  this is same as line 74. it will show all 6 properties which 
